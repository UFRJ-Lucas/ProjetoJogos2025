label office:
    ...
    voice "audio/narrador/office/03.wav" # faltando
    ...
    voice "audio/narrador/office/04.wav" # faltando
    "You panic for a moment. It's better to just start working on these as soon as possible."

    voice "audio/narrador/office/05.wav" # faltando
    ...
    voice "audio/narrador/office/11.wav" # faltando
    "Almost there..."
