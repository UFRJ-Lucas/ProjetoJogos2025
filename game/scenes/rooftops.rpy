label rooftops:
    ...
    menu:
        ...
        "Powerful":
            voice "audio/narrador/rooftops/03.wav" # faltando
            "Looking down on the city makes you feel powerful."

        "A sense of belonging":
            voice "audio/narrador/rooftops/04.wav" # faltando
            "Looking down on the city gives you a feeling of belonging."

    voice "audio/narrador/rooftops/05.wav" # faltando
